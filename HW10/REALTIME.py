...
def signal_processing(input):
    ...
    power = [[power_density_697, power_density_770, power_density_852, power_density_941],
             [power_density_1209, power_density_1336, power_density_1477, power_density_1633]]
    ...
    if power[0][index_max[0]] > tot[0] * 0.88 and power[1][index_max[1]] > 0.88 * tot[1]:
        #print('true')
